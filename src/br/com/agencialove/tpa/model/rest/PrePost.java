...
public class PrePost{
	...
	private String numeroEndRemetente;
	...
	private String celularRemetente;
	...
	public PrePost(String nomeDestinatario, String telefoneDestinatario, String cepDestinario, String numeroDestinario, String enderecoCompletoDestinario, String emailDestinario) {
		this.setNomeDestinatario(nomeDestinatario);
		this.setTelefoneDestinatario(telefoneDestinatario);
		this.setCepDestinatario(cepDestinario);
		this.setNumeroEndDestinatario(numeroDestinario);
		this.setLogradouroDestinatario(enderecoCompletoDestinario);
		this.setEmailDestinatario(emailDestinario);
	}
	...
	public String toJSON() {
		final String ret = "{" +
				...
				+"\"cpf_cnpj_remetente\":\"" + this.cpf_cnpj_remetente + "\","				
				...
				+"\"numero_remetente\":\"" + this.numeroEndRemetente + "\","
	...
	public String returnValues() {		
		 final String ret = "{" +
					...
					+ "\"numeroDestinatario\":\"" + this.numeroEndDestinatario + "\" },"
					+ "\"logradouroDestinatario\":\"" + this.logradouroDestinatario + "\" },"
					+ "\"emailDestinatario\":\"" + this.emailDestinatario + "\" },"
					+ "\"telefoneDestinatario\":\"" + this.telefoneDestinatario + "\" },"
					;
			return ret;
   }
	...
	public String getNumeroEndRemetente() {
		return this.numeroEndRemetente;
	}
	public void setNumeroEndRemetente(final String numeroRemetente) {
		this.numeroEndRemetente = numeroRemetente;
	}
	...
	public void setCelularRemetente(String celularRemetente) {
		this.celularRemetente = celularRemetente;
	}
	
	public String getCelularRemetente() {
		return celularRemetente;
	}
