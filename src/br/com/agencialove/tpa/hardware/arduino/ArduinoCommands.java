...
public enum ArduinoCommands {
	...
	STATE_BOX_P ("BOX_P_STATE",Type.BOX),
	OPEN_BOX_P ("BOX_P_OPEN",Type.BOX),
	CLOSE_BOX_P ("BOX_P_CLOSE",Type.BOX),
	
	STATE_BOX_M ("BOX_M_STATE",Type.BOX),
	OPEN_BOX_M ("BOX_M_OPEN",Type.BOX),
	CLOSE_BOX_M ("BOX_M_CLOSE",Type.BOX),
	
	STATE_BOX_G ("BOX_G_STATE",Type.BOX),
	OPEN_BOX_G ("BOX_G_OPEN",Type.BOX),
	CLOSE_BOX_G ("BOX_G_CLOSE",Type.BOX),
